...
class OurApproachBlockService extends BaseBlockService
{
    protected $container;
    protected $manager;
    ...
    public function configureEditForm(FormMapper $formMapper, BlockInterface $block): void
    {
        ...
        $formMapper
            ->add('settings', ImmutableArrayType::class, array(
                'keys' => array(
                    array('title', TextType::class, array('required' => false, 'label' => 'Heading ', 'help' => 'Max 50 Characters (Recommended)')),
                    ...
                    array($this->getMediaBuilder($formMapper, 'background_image', 'Background Image', true, 'Max Dimensions: 1920 x 865 px', array('provider' => 'sonata.media.provider.image')), null, array()),
                )
            ));
    }
