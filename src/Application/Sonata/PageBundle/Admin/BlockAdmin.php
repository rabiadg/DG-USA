...
final class BlockAdmin extends BaseBlockAdmin
{
    ...
    public function preUpdate(object $object): void
    {
        ...
        $this->insertBlockImagesByType($object);
    ...
    public function insertBlockImagesByType($object)
    {
        if ($object->getType() == 'sonata.cms.block.home_banner') {
            $object->setSetting('image', is_object($object->getSetting('image')) ? $object->getSetting('image')->getId() : null);
        }
    }
}
